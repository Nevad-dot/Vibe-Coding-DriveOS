  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 mb-5">
        {/* Google Button */}
        <Button onClick={handleSocialRegister} variant="outline-pill" className="w-full relative gap-3 h-[46px]">
          ...
          <span className="text-[14.5px] font-sans font-medium text-textGray-primary">Register With Google</span>
        </Button>
        ...
        <Button onClick={handleSocialRegister} variant="outline-pill" className="w-full relative gap-3 h-[46px]">
          ...
          <span className="text-[14.5px] font-sans font-medium text-textGray-primary">Register With Apple</span>
        </Button>
      </div>

      {/* Divider */}
      <div className="flex items-center gap-3 my-4">
        <div className="h-[1px] flex-1 bg-surfaceLight-border"></div>
        <span className="text-[11px] font-bold text-textGray-muted uppercase tracking-[0.1em]">OR</span>
        <div className="h-[1px] flex-1 bg-surfaceLight-border"></div>
      </div>
      ...
      <form onSubmit={handleRegister} className="flex flex-col gap-3">
        ...
        <Button type="submit" variant="brand" className="w-full mt-2 h-[46px] bg-green-gradient-pill text-white font-medium shadow-md border border-white/20">
          Create Account
        </Button>
      </form>
