...
import { Megaphone, Users, Target, CheckCircle2 } from "lucide-react";
...
export const CampaignsHistoryPanel: React.FC<CampaignsHistoryPanelProps> = ({ campaigns }) => {
  return (
    <motion.div
        ...
        <AnimatePresence initial={false}>
          {campaigns.map((camp) => (
            <motion.div
              ...
              className="p-4 rounded-2xl bg-surfaceLight-pearl border border-surfaceLight-border flex flex-col justify-between gap-3 shadow-2xs hover:border-[#4B8E55]/40 transition-all"
            >
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-emerald-500/15 text-emerald-600 border border-emerald-500/30 shrink-0 flex items-center gap-1">
