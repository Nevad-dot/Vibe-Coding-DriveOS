...
export const ReportsHeroHeader: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <h1 className="text-[28px] md:text-[34px] font-display tracking-tight leading-snug">
            <span className="font-semibold text-textGray-display">Laporan bisnis, </span>
            <span className="font-bold text-green-gradient">siap dalam 1 klik.</span>
          </h1>

          <p className="text-[14px] md:text-[15px] text-textGray-tertiary font-normal">
            6 template laporan · jadwal otomatis · PDF, Excel & CSV terstruktur.
          </p>
        </div>
      ...
      <CreateReportModal
        ...
        onSuccess={(title, format) => {
          setToastMessage(`Laporan ${title} (${format}) berhasil digenerate dan diunduh!`);
...
export default ReportsHeroHeader;
