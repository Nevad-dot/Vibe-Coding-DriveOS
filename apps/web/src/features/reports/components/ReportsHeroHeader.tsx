    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-[28px] md:text-[34px] font-display tracking-tight leading-snug">
          <span className="font-semibold text-textGray-display">Laporan yang </span>
          <span className="font-bold text-green-gradient">tepat waktu.</span>
        </h1>

        <p className="text-[14px] md:text-[15px] text-textGray-tertiary font-normal">
          18 template laporan · 6 laporan terjadwal · export PDF, Excel, CSV.
        </p>
      </div>
