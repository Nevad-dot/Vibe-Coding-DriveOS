    ...
    >
      ...
      <div className="pt-1.5 flex items-center">
        <motion.button
          ...
          className="px-5 py-2.5 rounded-full bg-green-gradient-pill text-white font-medium text-[13.5px] inline-flex items-center justify-center gap-2 shadow-xs transition-colors"
        >
