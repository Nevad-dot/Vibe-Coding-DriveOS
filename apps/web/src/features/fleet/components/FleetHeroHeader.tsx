    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-[28px] md:text-[34px] font-display tracking-tight leading-snug">
          <span className="font-semibold text-textGray-display">82% utilization — </span>
          <span className="font-bold text-green-gradient">idle turun.</span>
        </h1>

        <p className="text-[14px] md:text-[15px] text-textGray-tertiary font-normal">
          126 kendaraan aktif · 4 delivery on-route · 22 unit di bengkel/servis.
        </p>
      </div>
