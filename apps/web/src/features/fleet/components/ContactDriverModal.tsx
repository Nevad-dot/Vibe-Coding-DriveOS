      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-[480px] max-h-[88vh] overflow-y-auto bg-surfaceLight-card border border-surfaceLight-border rounded-3xl shadow-2xl z-10 p-4 sm:p-7 flex flex-col gap-4"
          >
            {/* Header */}
            ...
            {mode === "menu" && (
              <>
                {/* Driver Profile Card */}
                <div className="p-3.5 rounded-2xl bg-surfaceLight-pearl border border-surfaceLight-border/40 flex items-center gap-3">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="p-3 rounded-2xl bg-surfaceLight-pearl border border-surfaceLight-border/40 flex flex-col gap-0.5">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 pt-2.5 border-t border-surfaceLight-border/40 w-full">
                  <button
                    type="button"
              ...
              <>
                {waSentToast ? (
                  ...
                  <form onSubmit={handleSendWa} className="flex flex-col gap-3.5">
                    <div className="p-3 rounded-xl bg-surfaceLight-pearl border border-surfaceLight-border/40 flex items-center justify-between text-[12px]">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 rounded-xl bg-surfaceLight-pearl border border-surfaceLight-border/40 text-textGray-display text-[13px] placeholder:text-textGray-tertiary/60 focus:outline-none focus:border-[#4B8E55] transition-colors resize-none"
                      />
                    </div>

                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 pt-2 border-t border-surfaceLight-border/40">
                      <button
                        type="button"
                        onClick={() => setMode("menu")}
                        className="px-4 py-2 rounded-full border border-surfaceLight-border/40 bg-surfaceLight-card text-textGray-display text-[12.5px] font-semibold hover:bg-surfaceLight-pearl transition-colors cursor-pointer text-center"
                      >
                        Kembali
                      </button>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="px-4 py-2 rounded-full border border-emerald-500/30 text-emerald-600 hover:bg-emerald-500/10 text-[12.5px] font-semibold transition-colors cursor-pointer inline-flex items-center justify-center gap-1.5 whitespace-nowrap"
                        >
                        ...
                        <button
                          type="submit"
                          className="px-5 py-2 rounded-full bg-emerald-600 text-white text-[12.5px] font-semibold hover:bg-emerald-700 transition-all shadow-sm cursor-pointer inline-flex items-center justify-center gap-1.5 whitespace-nowrap"
                        >
