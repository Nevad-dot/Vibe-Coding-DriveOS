    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-[28px] md:text-[34px] font-display tracking-tight leading-snug">
          <span className="font-bold text-green-gradient">342 unit </span>
          <span className="font-normal text-textGray-tertiary">di 6 cabang.</span>
        </h1>

        <p className="text-[14px] md:text-[15px] text-textGray-tertiary font-normal">
          12 model dalam kategori low-stock · 4 restock dijadwalkan minggu ini.
        </p>
      </div>
...
export default InventoryHeroHeader;
