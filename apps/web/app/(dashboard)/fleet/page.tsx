...
export const metadata = {
  ...
  description: "Fleet Monitoring & Utilization — Real-time active vehicles, live delivery routes, and branch utilization.",
};
...
export default function FleetPage() {
  return (
    <div className="w-full flex flex-col">
      ...
      {/* Main Fleet Canvas: Slightly tinted gray background with metrics and panels */}
